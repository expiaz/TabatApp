...
public class CircularCounter extends View {
	...
	public final static int UPDATE_NOOP = -999;
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText(mText != null ? mText : Integer.toString(mOneValue), mOneBounds.centerX(), mTextPosY, mTextPaint);
	...
	public void changeThirdColor(int color) {
		mThreeColor = color;
		mThreePaint = new Paint();
		mThreePaint.setColor(mThreeColor);
		mThreePaint.setAntiAlias(true);
	...
	public CircularCounter setText(String text){
		this.mText = text;
		return this;
	}
